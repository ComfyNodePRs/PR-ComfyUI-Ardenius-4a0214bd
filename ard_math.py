...
class ARD_MATH:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "Ix": ("FLOAT", {"default": 1.0, "min": 0.1, "max": 9999999, "step": 0.1, "tooltip": "input float if you want to input integer use ARD integer to float node"}),
                "Iy": ("FLOAT", {"default": 1.0, "min": 0.1, "max": 9999999, "step": 0.1, "tooltip": "input float if you want to input integer use ARD integer to float node"}),
